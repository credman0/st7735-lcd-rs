    ...
    RST: OutputPin,
{
        ...
        DELAY: DelayMs<u8>,
    {
        ...
        self.write_command(Instruction::CASET, &[0x00, self.dx as u8, 0x00, (self.width + self.dx as u32) as u8])?;
        self.write_command(Instruction::RASET, &[0x00, self.dy as u8, 0x00, (self.height + self.dy as u32) as u8])?;
        
        self.write_command(Instruction::GMCTRP1, &[0x02,0x1c, 0x07,0x12, 0x37,0x32, 0x29,0x2d, 0x29,0x25, 0x2B,0x39, 0x00,0x01, 0x03,0x10])?;
        self.write_command(Instruction::GMCTRN1, &[0x03, 0x1d, 0x07, 0x06, 0x2E, 0x2C, 0x29, 0x2D, 0x2E, 0x2E, 0x37, 0x3F, 0x00, 0x00, 0x02, 0x10])?;
